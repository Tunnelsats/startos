...
export const main = sdk.setupMain(async ({ effects, started }) => {
   ...
   */
  console.info('Starting TunnelSats!')
  ...
  return sdk.Daemons.of(effects, started, healthReceipts).addDaemon('primary', {
    image: { id: 'tunnelsats' }, // Must match an Image ID declared in the manifest.
    command: ['tunnelsats'], // The command to start the daemon.
    ...
    requires: ['lnd', 'wireguard'], // If this daemon depends on the successful initialization of one or more prior daemons, enter their IDs here.
  })
})
